                ...
                e.showLoading({
                  ...
                  success: function (a) {
                    if (e.hideLoading(), 200 == a.statusCode)
                      if (200 == a.data.code) {
                        var n = a.data.data;
                        "https://oss.kuaitongkeji.com/static/img/avatar/male_64.png" == n.image && (t.flag = !0), t.faceimg = n.faceimg, t.image = n.avatar, t.parameter[0].value = n.nickname, 1 == n.sex && (t.parameter[1].value = "男"), 2 == n.sex && (t.parameter[1].value = "女"), t.parameter[3].value = n.username, t.parameter[4].value = n.tel.slice(0, 3) + "****" + n.tel.slice(7, 11), t.parameter[5].value = n.id_card_no.slice(0, 3) + "**********" + n.id_card_no.slice(n.id_card_no.length - 4, n.id_card_no.length)
                      } else e.showToast({
                        title: a.data.msg,
                        icon: "none"
                      });
